...
**Description**: Generate text using Gemini Chat API. Use for summarization, content generation, analysis, and AI-powered text processing.
...
| `api_key` | `string` | Yes | `-` | Gemini API key. Use ${{ env['GEMINI_API_KEY'] }} |
